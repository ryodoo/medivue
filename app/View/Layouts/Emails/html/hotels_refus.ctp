<div style="font-family: Arial, sans-serif; font-size: 16px; color: #333;">
    ...
    <p>Votre demande de réservation a été <strong>refusée</strong> par l’hôtel.</p>
    ...
    <ul>
        ...
        <li><strong>Motif du refus :</strong> <?php echo nl2br(h($reservation['Reservation']['reponse'])); ?></li>
    </ul>
