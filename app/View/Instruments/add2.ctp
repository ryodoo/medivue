...
<head>
	...
	<title>Scanner Badge - Medivue</title>
...
<div class="container">
				...
				<div class="form-section">
					...
					<div class="form-grid">
						<div class="form-field">
							...
							<input type="text" class="form-input" id="code" name="data[Instrument][code]">
						</div>
						<div class="form-field">
							<label class="form-label">Référence</label>
							<input type="text" class="form-input" id="ref" name="data[Instrument][ref]">
						</div>
						<div class="form-field">
							<label class="form-label">Nom</label>
							<input type="text" class="form-input" id="name" name="data[Instrument][name]">
						</div>
						<div class="form-field">
							<label class="form-label">Nom commercial</label>
							<input type="text" class="form-input" id="nomCommercial" name="data[Instrument][nom_comercial]">
						</div>
						<div class="form-field">
							<label class="form-label">Fournisseur</label>
							<input type="text" class="form-input" id="fournisseurName" autocomplete="off" placeholder="Rechercher un fournisseur...">
							<input type="hidden" id="fournisseurId" name="data[Instrument][fournisseur_id]">
							<div class="autocomplete-dropdown" id="fournisseurDropdown"></div>
						</div>
						<div class="form-field">
							<label class="form-label">Code fournisseur</label>
							<input type="text" class="form-input" id="codeFournisseur" name="data[Instrument][code_fournisseur]">
						</div>
						<div class="form-field">
							<label class="form-label">Taille</label>
							<input type="text" class="form-input" id="taille" name="data[Instrument][taille]">
						</div>
						<div class="form-field">
							<label class="form-label">Prix</label>
							<input type="text" class="form-input" id="prix" name="data[Instrument][prix]">
						</div>
						<div class="form-field">
							<label class="form-label">Numéro de lot</label>
							<input type="text" class="form-input" id="numLot" name="data[Instrument][num_lot]">
						</div>
						<div class="form-field full-width">
							<label class="form-label">Remarque</label>
							<textarea class="form-input form-textarea" id="remarque" name="data[Instrument][remarque]"></textarea>
						</div>
					</div>
				</div>
			</div>
	...
	<div class="page-content" id="page3">
		...
		<p class="scan-description">Processus terminé avec succès!</p>
	</div>
</div>
...
<script>
	...
	function submitForm() {
		...
		$.ajax({
			...
			error: function(xhr, status, error) {
				showNotification('error', 'Erreur', 'Impossible d\'enregistrer l\'instrument');
				nextButton.disabled = false;
				nextButton.innerHTML = 'Terminer <svg viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" d="M5 13l4 4L19 7"/></svg>';
			}
		});
	...
	function showPage(pageNumber) {
		...
		const helpTexts = {
			...
			2: 'Remplissez le formulaire et capturez une photo',
			3: 'Cliquez sur Terminer pour enregistrer'
		};
